...
public partial class AnliTypeList : System.Web.UI.Page
{
    ...
    public void bindDate(int _Page)
    {
        ...
        WebControl.CreatTable(showTable, "id,name", "编号,名称", dp.C_Pagination(new string[] { PageIndex, "50", "id,name", "prdct_type", " tag=0 and type=2", "ID DESC" }, ref RecordCount, ref PageCount), "ModAnLiType.aspx?id=", "goods", true);
