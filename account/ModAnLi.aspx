<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModAnLi.aspx.cs" Inherits="account_ModAnLi" %>
        ...
        <div class="main-container-inner">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <h3 class="header smaller lighter blue">案例管理</h3>
                    <!-- /.page-header -->
                        ...
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" role="form" runat="server">
                                ...
                                <div class="form-group" style="margin-bottom: 0;">
                                    <label for="form-field-select-1" class="col-md-1">案例分类</label>
                                ...
                                <div class="form-group">
                                    <label for="form-field-select-1" class="col-md-1">案例名称</label>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                         <p style="color:red">注意：建议上传500*340的封面图</p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="form-field-select-1" class="col-md-1">案例简介</label>
                                </div>
                                <div class="editorbox">
                    ...
                    success: function (data) {
                        if (data) {
                            ...
                            if (dt.data4 != "") {
                                ...
                                var _html = '';
                                $.each(dt.data4.split('|'), function (i) {

                                    _html += '<div class="news-img"><div class="img-del"><img src="/images/set-img-del.png" class="new-upload set-del-img" data-img="' + dt.data4.split('|')[i] + '"/></div><img src="../UploadFile/images/' + dt.data4.split('|')[i] + '" alt="" class="set-up-img"/></div>';
                                });
                                $("#imgup").prepend(_html);
                            }
