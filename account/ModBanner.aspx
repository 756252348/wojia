<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModBanner.aspx.cs" Inherits="account_ModBanner" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" role="form" runat="server">
                                ...
                                <div class="form-group">
                                    <label for="form-field-select-1" class="col-md-1">链接</label>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group" style="overflow:hidden;">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                         <p style="color:red">注意：建议上传1920*650的封面图</p>
                                    </div>
                                </div>
                                <div class="clearfix">
                                    <div class="col-md1">
