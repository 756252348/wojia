<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModNewsCompany.aspx.cs" Inherits="account_ModNewsCompany" %>
        ...
        <div class="main-container-inner">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <h3 class="header smaller lighter blue">公司新闻</h3>
                    <!-- /.page-header -->
                        ...
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" role="form" runat="server">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                         <p style="color:red">注意：建议上传276*200的封面图</p>
                                    </div>
                                </div>
                    ...
                    success: function (data) {
                        if (data) {
                            ...
                            $('input[name="tindex"]').each(function () {
                                var _this = $(this), ks = data.data4=="False"?"0":"1";
