...
public partial class account_ModNewsCompany : System.Web.UI.Page
{
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        obj = dp.proc_news_infos(new string[] { id,"1", Request["txt_name"], Request["txt_cont"], Request["pro_img"], Request["txt_intro"], Request["txt_tj"] });
