...
public partial class account_ModNewsPrdct : System.Web.UI.Page
{
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        obj = dp.proc_news_infos(new string[] { id, "2", Request["txt_name"], Request["txt_cont"], Request["pro_img"], Request["txt_intro"], Request["txt_tj"] });
