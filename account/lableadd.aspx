<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lableadd.aspx.cs" Inherits="account_lableadd" %>
            ...
            <div class="main-content">
                <div class="page-content">
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <h3 class="header smaller lighter blue">标签管理</h3>

                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-green2">
                                            <h4 class="lighter smaller">标签设置</h4>
                                            ...
                                            <div class="widget-main padding-8">
                                                <form class="form-horizontal" role="form" runat="server">
                                                    <div class="form-group">
                                                        <label class="col-xs-3 control-label no-padding-right" for="form-field-1">标签名称 </label>
        ...
        jQuery(function ($) {
            ...
            $('.icon-trash').click(function () {                
                ...
                $.ajax({
                    ...
                    type: "POST",
                    async: true,
                    data: { dataType: "lableinfo", parms: [_id, ""] },
                    cache: true,
                    dataType: "json",
                    beforeSend: function () { },
