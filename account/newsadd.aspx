<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newsadd.aspx.cs" Inherits="account_newsadd" %>
                        ...
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" role="form" runat="server">
                                ...
                                <div class="form-group" style="margin-bottom: 0;">
                                    <label for="form-field-select-1" class="col-md-1">新闻分类</label>
                                    <input type="hidden" value="" runat="server" id="txt_newslist" />
                                    <div class="col-md-8 news-category" id="city_custom">
                                        ...
                                        <input type="hidden" id="txt_nid" runat="server" />

                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="form-field-select-1" class="col-md-1">新闻标题</label>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <label for="form-field-select-1" class="col-md-1">新闻描述</label>
                                    <div class="col-md-6">
                                        <input type="text" id="txt_dis" runat="server" />
                                    </div>

                                </div>
                                <div class="form-group">
                                    <label for="form-field-select-1" class="col-md-1">新闻链接</label>
                                    <div class="col-md-3">
                                        <input type="text" id="txt_link" runat="server" />
                                    </div>
                                    <label for="form-field-select-1" class="col-md-6">(新闻类别为banner时填写)</label>
                                </div>
                                <div class="form-group" style="overflow:hidden;">
                                    <label class="col-md-1">新闻图片</label>
                                ...
                                <div class="form-group" style="overflow:hidden;">
                                    <label class="col-md-1">新闻图片(移动)</label>
                                ...
                                <div class="form-group">
                                    <label for="form-field-select-1" class="col-md-1">新闻内容</label>
                                </div>
                                <div class="editorbox">
...
<![endif]-->
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            var dt = $.parseJSON($('#txt_newslist').val());
            ...
            if (_id) {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data) {
                            var dt = data;
                            $('.first').val(data.data0);//商品分类
                            $('#txt_title').val(dt.data1);//标题
                            $('#txt_dis').val(dt.data5);//描述
                            $('#txt_link').val(dt.data6);//链接

                            $('#editor1').text(dt.data4);//简介
                            ...
                            if (dt.data3 != "") {
                                $('#pro_img2').val(dt.data3);//移动图片
                                var _html2 = '';
                                $.each(dt.data3.split('|'), function (i) {

                                    _html2 += '<div class="news-img"><div class="img-del"><img src="/images/set-img-del.png" class="new-upload2 set-del-img" data-img="' + dt.data3.split('|')[i] + '"/></div><img src="../UploadFile/images/' + dt.data3.split('|')[i] + '" alt="" class="set-up-img"/></div>';
                                });
