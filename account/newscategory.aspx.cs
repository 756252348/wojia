...
using System.Data;
using System.Text;
public partial class account_newscategory : System.Web.UI.Page
{
    ...
    public string databind(string parentid)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            for (int i = 0, leng = dt.Rows.Count; i < leng; i++)
            {
                ...
                sb.Append("<a class=\"blue newitem\" href=\"javascript:;\" data-id=\"" + dt.Rows[i][0].ToString() + "\" data-pid=\"" + dt.Rows[i][2].ToString() + "\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"编辑\">");
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        obj = dp.proc_news_type_info(new string[] { Request["txt_id"] , Request["txt_pid"], Request["txt_name"], "0" });
