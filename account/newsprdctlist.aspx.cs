...
public partial class account_newsprdctlist : System.Web.UI.Page
{
    ...
    public void bindDate(int _Page)
    {
        ...
        WebControl.CreatTable(showTable, "id,title,addtime", "编号,新闻标题,添加时间", dp.C_Pagination(new string[] { PageIndex, "50", "id,title,addtime", "News_info", " tag=0 and type=2", "ID DESC" }, ref RecordCount, ref PageCount), "ModNewsPrdct.aspx?id=", "goods", true);
