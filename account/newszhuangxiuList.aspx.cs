...
public partial class account_newszhuangxiuList : System.Web.UI.Page
{
    ...
    public void bindDate(int _Page)
    {
        ...
        WebControl.CreatTable(showTable, "id,title,addtime", "编号,新闻标题,添加时间", dp.C_Pagination(new string[] { PageIndex, "50", "id,title,CONVERT(varchar(10),addtime, 120) as addtime", "News_info", " tag=0 and type=3", "ID DESC" }, ref RecordCount, ref PageCount), "ModZhuangxiu.aspx?id=", "goods", true);
