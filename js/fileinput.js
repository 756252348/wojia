...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeTitle: '删除',//'Remove file',
                    uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
                    uploadClass: 'btn btn-xs btn-default',
                    uploadTitle: '上传',//'Upload file',
                    zoomIcon: '<i class="glyphicon glyphicon-zoom-in"></i>',
                    zoomClass: 'btn btn-xs btn-default',
                    zoomTitle: '预览',//'View Details',
                    ...
                    indicatorNewTitle: '还未上传',//Not uploaded yet
                    indicatorSuccessTitle: '已上传',//Uploaded
                    indicatorErrorTitle: '上传出错',//Upload Error
                    indicatorLoadingTitle: '上传中 ...'//Uploading
                }
            };
        ...
        _resetFileStack: function () {
            ...
            self._getThumbs().each(function (ks) {
                ...
                if (file !== undefined) {
                    ...
                    $thumb.attr({ 'id': self.previewInitId + '-' + i, 'data-fileindex': ks });
                    i++;
                } else {
                    newId = 'uploaded-' + $h.uniqId();
                    $thumb.attr({ 'id': newId, 'data-fileindex': ks });
